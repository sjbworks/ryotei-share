...
export default function Legal() {
  ...
  const h1Style = 'text-xl font-bold mb-6 text-gray-800'
  const sectionStyle = 'mb-8 flex flex-col gap-2 break-all'
  const h2Style = 'text-lg font-semibold mb-3 text-gray-700'
  const h3Style = 'text-base font-semibold mb-2 text-gray-700'
  const paragraphStyle = 'mb-4 text-gray-600 leading-relaxed break-all'
  const listStyle = 'list-disc list-inside mb-4 text-gray-600 space-y-1'

  return (
    <div className={containerStyle}>
      <div className="mb-6">
        <Link href="/" className="text-gray-700 hover:text-gray-400 underline">
          ← ホームに戻る
        </Link>
      </div>
      ...
      <section className={sectionStyle}>
        ...
        <p className={paragraphStyle}>
          ...
          <Link href={'https://github.com/sjbworks/ryotei-share'} className="hover:text-gray-400 underline">
            GitHubリポジトリ
          </Link>
          のIssueにてお寄せください。
        </p>
